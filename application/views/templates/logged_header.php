            ...
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a role="button" data-toggle="collapse" href="#collapseExample"
                       aria-expanded="false" aria-controls="collapseExample">Messages <span class="badge">2</span></a>
                </li>
                <li>
                    <a role="button" data-toggle="collapse" href="#collapsenotif"
                       aria-expanded="false" aria-controls="collapsenotif">Notifications <span class="badge">1</span></a>
                </li>
                <li class="dropdown">
